...
require.define("/sample/image-sample.js",function(require,module,exports,__dirname,__filename,process){var uijs = require('uijs');
...
require.define("/sample/.tmp.50038.entry.image-sample.js",function(require,module,exports,__dirname,__filename,process){window.require = require;

// lazy require so that app code will not execute before onload
Object.defineProperty(window, 'main', {
  get: function() {
    return require('./image-sample.js');
  }
});});
require("/sample/.tmp.50038.entry.image-sample.js");
})();
