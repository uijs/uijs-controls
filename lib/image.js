...
module.exports = function(options) {
  ...
  obj.boxWidth = obj.width;
  obj.width = function(){
    var self = this;
    return (self.adaptSizeAccordingToImage) ? self.image.width : self.boxWidth;
  };

  obj.boxHeight = obj.height;
  obj.height = function(){
    var self = this;
    return (self.adaptSizeAccordingToImage) ? self.image.height : self.boxHeight;
  };
