...
module.exports = function(options) {
  ...
  var input = html({
    width: bind(function(){ return (obj.cancelIcon && obj.cancelIcon.visible) ? obj.width - obj.cancelIcon.width - 5 : obj.width; }),
    height: bind(function(){ return obj.height; }),
  ...
  if(obj.cancelIcon){
  	...
  	obj.cancelIcon.x = bind(obj.cancelIcon, 'x', function(){ return obj.width - obj.cancelIcon.width; });
  	obj.cancelIcon.y = 0;

  	obj.watch('text', function(newValue){
		  obj.cancelIcon.visible = (newValue != '');
  	});
