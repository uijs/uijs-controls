...
module.exports = function(options) {
  ...
  function onDrawLabel(ctx) {
    ...
    var w = self.width = (self.adjustsBoxSizeToFitFontSize) ? textWidth + Math.abs(shadowOffsetWidth) : self.width;
    var h = self.height = (self.adjustsBoxSizeToFitFontSize) ? textHieght + Math.abs(shadowOffsetHeight) : self.height;
    w = parseInt(w);
    h = parseInt(h);
