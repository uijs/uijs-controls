...
module.exports = function(options) {
  ...
  function get_content_children() {
    ...
    if(needToInitCachePool && cachePool.length == 0 && obj.items.length > 0){
    ...
    var res = (obj.searchBar) ? [obj.searchBar].concat(cachePool) : (needToInitCachePool ? cachePool : cachePool.concat());
