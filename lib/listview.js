...
module.exports = function(options) {
  ...
  function get_content_children() {
    ...
    */
    ...
    //if(cachePoolInitializedThisFrame){
      ...
      if(obj.searchBar && self.y > -obj.searchBar.height) {
        children.push(obj.searchBar);
      }

      children = children.concat(cachePool.slice(startItemIndex, endItemIndex));
  ...
  obj.watch('height', function(){
    createCachePool();
  });

  obj.watch('itemHeight', function(){
    createCachePool();
  });
